...
model CC_HIL_sens_no_rot_val_mot_boost
  ...
  Developed.Valves.ReliefValve reliefValve1(Av = 0.001, Cd = 1, CvData = Modelica.Fluid.Types.CvTypes.Av, p_open = 9.5e5, p_relief = 9e5) annotation(
...
equation
  ...
  annotation(
    ...
    Diagram);
end CC_HIL_sens_no_rot_val_mot_boost;
