...
model w2w_sens_hydro2
  ...
  Developed.Cylinders.DoubleActingCylinder doubleActingCylinder(boreDiameter = 0.19, compressibleEnable = true, strokeLength = 2.5, pistonRodMass = 5, maxPressure = 2e8, leakageEnable = true, Cv = 50, f_c = 100, Cst = 5, f_st = 20, CHeadExLeakage = 0.00000002, CRodExLeakage = 0.00000002, CInLeakage = 0.000000005, damping = 0, stribeckFrictionEnable = true, p_init = 1.5e6, closedLength = 0.001, initType = Developed.Types.RevoluteInit.Position, s_init = 1.25) annotation(
  ...
  Developed.Volumes.Accumulator hpAccumulator(gasVolume = 1, initType = Developed.Types.AccInit.Volume, liquidVolume = 0.95, p_init(displayUnit = "bar") = 4.5e6, p_precharge(displayUnit = "bar") = 3e6, p_max = 2e8, V_init = 0.5) annotation(
