...
Modelica.Units.SI.Force Fpto = doubleActingCylinder.boreDiameter^2/4*3.14*(hpAccumulator.port_a.p - lpAccumulator.port_a.p)*sign(float.body.absoluteSensor.v[3]);
  ...
  Modelica.Blocks.Sources.Ramp ramp(height = 104.7198, duration = 5)  annotation(
    Placement(transformation(origin = {174, 14}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
equation
  ...
  connect(v4_3cc.portB, doubleActingCylinder.port_b) annotation(
    Line(points = {{-42, -18}, {-42, -16}, {-36, -16}, {-36, 14}}, color = {255, 0, 0}));
  connect(v4_3cc.portA, doubleActingCylinder.port_a) annotation(
    Line(points = {{-42, -26}, {-42, -24}, {-52, -24}, {-52, 14}}, color = {255, 0, 0}));
  ...
  connect(v4_3cc.portP, lpAccumulator.port_a) annotation(
    Line(points = {{-26, -26}, {-26, -24}, {32, -24}, {32, -12}}, color = {255, 0, 0}));
  connect(v4_3cc.portT, hpAccumulator.port_a) annotation(
    Line(points = {{-26, -18}, {-2, -18}, {-2, 28}, {32, 28}}, color = {255, 0, 0}));
  ...
  connect(ramp.y, speed.w_ref) annotation(
    Line(points = {{164, 14}, {118, 14}}, color = {0, 0, 127}));
  annotation(
