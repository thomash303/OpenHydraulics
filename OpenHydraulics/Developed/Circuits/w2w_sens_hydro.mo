...
model w2w_sens_hydro
  ...
  Developed.Machines.VariableDisplacementMotor variableDisplacementMotor(Dmax = 312e-6*0.5, Dmin = 312e-6*0.5, p_init(displayUnit = "bar") = 7e6, frictionEnable = false, leakageEnable = false) annotation(
