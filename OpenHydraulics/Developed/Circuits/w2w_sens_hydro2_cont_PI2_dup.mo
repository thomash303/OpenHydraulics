...
model w2w_sens_hydro2_cont_PI2_dup
  ...
  parameter Modelica.Units.SI.Voltage VNominal = 150 "Nominal RMS voltage per phase";
  ...
  Modelica.Blocks.Sources.Ramp motorDisplacementFraction(duration = 0.15, height = 157.5) annotation(
