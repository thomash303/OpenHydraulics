...
model CC_HIL_sens_no_rot_val_mot_boost_c_mot_cyl_boost2
  ...
  Modelica.Blocks.Sources.Ramp ramp(height = (47 - 57)*2*3.14/60, duration = 60, offset = (47 + 10)*2*3.14/60, startTime = 60) annotation(
  ...
  Developed.Valves.ReliefValve reliefValve1(Av = 1e-8, Cd = 1, CvData = Modelica.Fluid.Types.CvTypes.Av, p_open = 7.5e5, p_relief = 7e5) annotation(
...
equation
  ...
  annotation(
    ...
    Diagram);
end CC_HIL_sens_no_rot_val_mot_boost_c_mot_cyl_boost2;
