...
model cylinder_driving
  ...
  Cylinders.DoubleActingCylinder doubleActingCylinder(strokeLength = 0.4, q_nom = 1e-4, pistonRodMass = 0.1, s_init = 0.185, leakageEnable = false, stribeckFrictionEnable = false, Cv = 0, f_st = 1, f_c = 0, compressibleEnable = true, CRodExLeakage = 0.001)  annotation(
...
equation
  ...
  connect(doubleActingCylinder.port_b, fluidPower2MechRotConst.port_a) annotation(
    Line(points = {{74, 40}, {76, 40}, {76, -58}, {6, -58}, {6, -44}}, color = {255, 0, 0}));
  annotation(
