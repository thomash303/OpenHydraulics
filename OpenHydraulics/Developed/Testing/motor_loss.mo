...
model motor_loss
  ...
  Machines.VariableDisplacementMotor variableDisplacementMotor(p_init(displayUnit = "bar") = 3.5e6, CsD = {25, 50, 75, 100}, CvD = {25, 50, 75, 100}, CfD = {25, 50, 75, 100}, Cs = 5000*{3.2576e-9, 2.7658e-9, 2.1634e-9, 2.8241e-9}, Cv = {207433, 249350, 286122, 313991}, frictionEnable = false, leakageEnable = true, Dmax = 4e-6, Dmin = -4e-6, Cf = {-0.0012, -0.0017, -0.0017, -0.0003}) annotation(
...
equation
  ...
  connect(ramp.y, variableDisplacementMotor.dispFraction) annotation(
    Line(points = {{58, 30}, {9, 30}, {9, -9}}, color = {0, 0, 127}));
