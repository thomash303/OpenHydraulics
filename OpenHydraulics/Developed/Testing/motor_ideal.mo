...
model motor_ideal
  ...
  Machines.VariableDisplacementMotor variableDisplacementMotor(p_init(displayUnit = "bar") = 3.5e6, CsD = {25, 50, 75, 100}, CvD = {25, 50, 75, 100}, CfD = {25, 50, 75, 100}, Cs = {-3.2576e-9, -2.7658e-9, -2.1634e-9, -2.8241e-9}, Cv = {-0.0012, -0.0017, -0.0017, -0.0003}, Cf = {207433, 249350, 286122, 313991}, frictionEnable = false, leakageEnable = false, Dmax = 4e-6, Dmin = -4e-6) annotation(
  ...
  OpenHydraulics.Developed.Sensors.FlowSensor flowSensor1 annotation(
    Placement(transformation(origin = {0, -30}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Mechanics.Rotational.Components.Damper damper(d = 0.005, w_rel(displayUnit = "rpm", fixed = true, start = -157.07963267948966)) annotation(
