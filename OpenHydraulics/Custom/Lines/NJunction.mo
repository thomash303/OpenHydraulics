within OpenHydraulics.Custom.Lines;
...
equation
  connect(port, volumeClosed.port) annotation(
    Line(points = {{0, 0}, {0, -30.05}}, color = {255, 0, 0}));
  annotation(
    defaultComponentName = "j1",
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-50, 48}, {50, -38}}, lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Text(extent = {{0, -26}, {0, -56}}, lineColor = {0, 0, 255}, textString = "%name"), Ellipse(extent = {{-20, 20}, {20, -20}}, lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid)}),
