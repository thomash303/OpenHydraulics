...
model DoubleActingCylinderNoCushion
...
equation
  ...
  connect(port_b, jB.port[1]) annotation(
    Line(points = {{80, -80}, {40, -80}, {40, -80.5}}, color = {255, 0, 0}));
  connect(cylinderChamberRod.port[1], jB.port[2]) annotation(
    Line(points = {{40, 0}, {40, -80}}, color = {255, 0, 0}, thickness = 0.5));
  connect(cylinderChamberHead.port[1], jA.port[2]) annotation(
    Line(points = {{-40, 0}, {-40, -80}}, color = {255, 0, 0}, thickness = 0.5));
  annotation(
...
end DoubleActingCylinderNoCushion;
